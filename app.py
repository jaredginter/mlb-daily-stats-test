...
def fip_xwoba_quadrant(avg_xwoba, fip, pitcher_name, batting_team, pitching_team,
    ...
    SCENARIOS = {
        ...
        (2, 0): (
            ...
            f"Home Run Suppression: Pitchers with low xFIPs excel at forcing ground balls. Even if a hitter hits a ground ball hard (yielding a decent xwOBA), ground balls rarely result in extra-base hits or home runs."
